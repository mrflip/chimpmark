...
%default PAGELINKS_PREP_FILE '/tmp/wikidump/pagelinks_prep'
...
%default PAGE_INFO_SORTED_FILE  '/data/rawd/wikidump/page_info_sorted'
PageInfo     = LOAD '$PAGE_INFO_FILE' AS (page_id:long, ns:int, title:chararray, restr:chararray, counter:long, is_redir:int, is_new:int, rand:float, touched:long, latest_rev:long, len:long);
PageInfo_sorted = ORDER PageInfo BY page_id ASC;
rmf                   $PAGE_INFO_SORTED_FILE
STORE Pagelinks INTO '$PAGE_INFO_SORTED_FILE';
